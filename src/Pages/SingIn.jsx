...
import signIn from "../assets/imgs/signIn.jpg"
...
const SingIn = () => {
    ...
    return (
        <div className="max-w-[1920px] mx-auto md:w-[85%]">
            ...
            <div className="border rounded-lg shadow-lg mt-10">
                    ...
                    <div className="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                        <div className=" p-5 ">
                            ...
                            <form onSubmit={handleLogin} className="space-y-3 w-full ">
                                ...
                                <button type='submit' className="px-3 py-2 bg-[#FF497C] hover:bg-[#ab3154] rounded text-white font-semibold">
                                    Sign In
                                </button>
                            </form>
                        </div>
